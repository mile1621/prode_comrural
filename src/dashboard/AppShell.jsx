 ...
 *
 * v3:
 *  - Layout de app real: nav arriba, main scrolleable, footer abajo.
 *  - Evita que el footer quede en el medio cuando el contenido crece.
 *  - El scroll queda dentro de <main>, no en el documento completo.
 */
