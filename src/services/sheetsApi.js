/* ============================================================
   ...
   Toda la comunicación pasa por /.netlify/functions/sheets
   ============================================================ */
...
const partidos = {
  ...
  sincronizar: (filtros = {}) => get('partidos.sincronizar', filtros),
}

const predicciones = {
  guardar: (data) => post('predicciones.guardar', data),
  mias: (apuesta_id = '') => get('predicciones.mis', apuesta_id ? { apuesta_id } : {}),
  tabla: (apuesta_id) => get('predicciones.tabla', { apuesta_id }),
}
